    ...
    public static void main(String args[]){
        if(args.length == 0) {
            ...
            try {
                ...
                new Client(serverIp, serverPort, filename, filePath, payloadSize, null, null);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
        else {
            new Client(args[0], Integer.parseInt(args[1]), args[2], args[3], Integer.parseInt(args[4]), null, null);
        }
    }
}
